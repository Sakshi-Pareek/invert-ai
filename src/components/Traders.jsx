        ...
        <div className="container lg:max-w-[1164px] px-3 mx-auto relative z-10">
          ...
          <div className="flex flex-wrap relative x-[1] items-center max-lg:gap-10">
            <div className="lg:w-[49%]">
              <h3 className="text-white font-bold sm:text-[40px] text-[30px] leading-[120%] max-lg:text-center">
                Empowering your{" "}
              ...
              <p className="font-normal text-base text-white opacity-70 my-4 pb-4 max-lg:text-center">
                InvestGPT offers a dynamic facility for users who are ready to
                actively engage in trading.
              </p>
              <div className="border-2 border-solid border-[#ab68ff4d] rounded-[161px] px-2.5 py-2 flex gap-4 bg-[#110B26] mb-6 hover:shadow-[0px_0px_6px_0px_rgba(171,104,255,0.6)] duration-300 ease-linear transition-all cursor-pointer items-center">
                <Fund />
                <div>
              ...
              <div className="border-2 border-solid border-[#ab68ff4d] rounded-[161px] px-2.5 py-2 flex gap-4 bg-[#110B26] lg:mb-10 mb-8 hover:shadow-[0px_0px_6px_0px_rgba(171,104,255,0.6)] duration-300 ease-linear transition-all cursor-pointer items-center">
                <Setting />
                <div>
                  <h4 className="font-semibold text-base text-white mb-2.5">
                    Setting Parameters
                  ...
                  <p className="font-normal text-base text-white opacity-70">
                    You'll have the opportunity to specify parameters such risk.
                  </p>
                </div>
              </div>
            ...
            <div className="lg:w-[49%] mx-auto">
              <div className="sm:w-[465px] w-[320px] sm:h-[465px] h-[320px] rounded-[50%] border-2 border-dashed border-[#ffffff1a] flex justify-center items-center lg:ml-auto relative">
                ...
                <Image
                  ...
                  width={128}
                  height={128}
                  className="absolute right-0 top-0 max-sm:w-[100px]"
                />
