  ...
  return (
    <>
      <div className="relative">
        <Image
          src="/assets/images/png/hero_bottom_layer.png" alt="bottom-layer"
        ...
        <div className="xl:pt-52 lg:pt-28 md:pt-20 pt-12 xl:mt-1 container lg:max-w-[1164px] px-3 mx-auto relative">
          ...
          <h1 className="text-white font-bold lg:text-[40px] md:text-[34px] text-[28px] leading-[120%] text-center lg:mb-14 mb-5 xl:pb-1" data-aos="fade-down">
            Your Personal{" "}
          ...
          <div className="flex flex-wrap-reverse justify-between max-lg:gap-6 max-sm:gap-4 items-center">
            <div className="lg:w-[23.5%] xs:w-[48%] border-2 border-solid border-[#ab68ff4d] bg-gradient-bg bg-full rounded-[24px] pt-6 sm:px-5 px-3 overflow-hidden min-h-[304px] backdrop-blur-sm glass cursor-pointer hover:shadow-[0px_0px_6px_0px_rgba(171,104,255,0.6)] duration-300 ease-linear" data-aos="fade-up">
              <Financial />
            ...
            <div className="lg:w-[23.5%] xs:w-[48%] border-2 border-solid border-[#ab68ff4d] bg-gradient-bg bg-full rounded-[24px] pt-6 sm:px-5 px-3 overflow-hidden min-h-[304px] backdrop-blur-sm glass cursor-pointer hover:shadow-[0px_0px_6px_0px_rgba(171,104,255,0.6)] duration-300 ease-linear" data-aos="fade-down">
              <Personal />
              <h2 className="font-semibold text-base text-white mt-6 mb-3.5">
                Personal Details
              </h2>
          ...
          <div className="flex flex-wrap-reverse justify-between max-lg:gap-6 max-sm:gap-4 items-center mt-6 relative z-10">
            ...
            <div className="lg:w-[49.5%] border-2 border-solid border-[#ab68ff4d] bg-gradient-bg backdrop-blur-sm bg-full rounded-[24px] py-6 sm:px-5 px-3 overflow-hidden min-h-[304px] glass cursor-pointer hover:shadow-[0px_0px_6px_0px_rgba(171,104,255,0.6)] duration-300 ease-linear" data-aos="fade-right">
              <Savings />
              <h2 className="font-semibold text-base text-white mt-6 mb-3.5">
